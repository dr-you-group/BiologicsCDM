...
SELECT * INTO @target_database_schema.@target_cohort_table_DupiPed6_temp FROM Tcumul
...
INTO @target_database_schema.@target_cohort_table_DupiPed6
FROM @target_database_schema.@target_cohort_table_DupiPed6_temp
GROUP BY SUBJECT_ID, 
         cohort_start_date;
DROP TABLE @target_database_schema.@target_cohort_table_DupiPed6_temp;