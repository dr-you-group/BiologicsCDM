...
SELECT * INTO @target_database_schema.@target_cohort_table_OmaAll6_temp FROM Tcumul
...
INTO @target_database_schema.@target_cohort_table_OmaAll6
FROM @target_database_schema.@target_cohort_table_OmaAll6_temp
GROUP BY SUBJECT_ID, 
         cohort_start_date;
DROP TABLE @target_database_schema.@target_cohort_table_OmaAll6_temp;