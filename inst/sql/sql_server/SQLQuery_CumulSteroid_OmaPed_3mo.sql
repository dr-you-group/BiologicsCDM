...
cohort as (
	...
	where cohort_definition_id = 1439
	), 
Tdrug as (
...
SELECT * INTO @target_database_schema.@target_cohort_table_OmaPed3_temp FROM Tcumul
...
INTO @target_database_schema.@target_cohort_table_OmaPed3
FROM @target_database_schema.@target_cohort_table_OmaPed3_temp
GROUP BY SUBJECT_ID, 
         cohort_start_date;
DROP TABLE @target_database_schema.@target_cohort_table_OmaPed3_temp;
