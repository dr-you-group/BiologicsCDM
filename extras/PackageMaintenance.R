...
OhdsiRTools::checkUsagePackage("BiologicsCDMnew")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/BiologicsCDMnew.pdf")
shell("R CMD Rd2pdf ./ --output=extras/BiologicsCDMnew.pdf")
...
OhdsiRTools::createRenvLockFile("BiologicsCDMnew")
